...
`net2.0` is fully pushed and released as of **v5.9** (`0bd9668`, https://github.com/nshelke23/net2.0/releases/tag/v5.9) — nothing sitting local-only there right now (check `git log origin/main..HEAD` in a fresh clone to be sure this hasn't drifted since).
